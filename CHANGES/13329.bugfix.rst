...
connection error is raised instead. A multipart body now reports itself as
unreplayable when any of its parts is, so neither the retry nor the redirect path
resends it with a drained part missing.
