...
# URLs for httpbin digest auth (qop=auth-int) with different algorithms
DIGEST_AUTH_URLS = {
    "SHA-256": URL("https://httpbin.org/digest-auth/auth-int/my/dog/SHA-256"),
    "MD5": URL("https://httpbin.org/digest-auth/auth-int/my/dog/MD5"),
    "SHA-512": URL("https://httpbin.org/digest-auth/auth-int/my/dog/SHA-512"),
}
