...
DIGEST_AUTH_SHA256_URL = URL("https://httpbin.org/digest-auth/auth-int/my/dog/SHA-256")
DIGEST_AUTH_MD5_URL = URL("https://httpbin.org/digest-auth/auth-int/my/dog/MD5")
