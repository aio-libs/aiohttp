...
class TestParsePayload:
    ...
    async def test_parse_length_payload_eof(self, protocol: BaseProtocol) -> None:
        out = aiohttp.StreamReader(protocol, DEFAULT_CHUNK_SIZE, loop=asyncio.get_running_loop())
...
class TestDeflateBuffer:
    async def test_feed_data(self, protocol: BaseProtocol) -> None:
        buf = aiohttp.StreamReader(protocol, DEFAULT_CHUNK_SIZE, loop=asyncio.get_running_loop())
