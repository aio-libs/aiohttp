...
def test_one_hundred_get_requests_with_1mb_chunked_payload(
    ...
    """Benchmark 100 GET requests with a payload of 1 MiB using read."""
    message_count = 100
    payload = b"a" * 2**20
...
def test_one_hundred_get_requests_iter_chunks_on_1mb_chunked_payload(
    ...
    """Benchmark 100 GET requests with a payload of 1 MiB using iter_chunks."""
    message_count = 100
    payload = b"a" * 2**20
...
def test_one_hundred_get_requests_with_1mb_content_length_payload(
    ...
    """Benchmark 100 GET requests with a payload of 1 MiB."""
    message_count = 100
    payload = b"a" * 2**20
    headers = {hdrs.CONTENT_LENGTH: str(len(payload))}
