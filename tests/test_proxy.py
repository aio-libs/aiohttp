...
class TestProxy(unittest.TestCase):
    response_mock_attrs = {"status": 200}
    ...
    def test_connect(self, ClientRequestMock) -> None:
        ...
        proto = mock.Mock(**{"transport.get_extra_info.return_value": False})
    ...
    def test_proxy_auth(self) -> None:
        ...
        self.assertEqual(
            ctx.exception.args[0], "proxy_auth must be None or BasicAuth() tuple"
        )
