...
def test_proxy_scheme_err(make_request: _RequestMaker) -> None:
    with pytest.raises(ValueError, match="'socks5'"):
        make_request("get", URL("http://py.org/"), proxy=URL("socks5://127.0.0.1:80"))
    with pytest.raises(ValueError, match="'socks5h'"):
        make_request("get", URL("http://py.org/"), proxy=URL("socks5h://127.0.0.1:80"))
