...
async def test_tcp_connector_fingerprint_ok(aiohttp_server, aiohttp_client, ssl_ctx):

    fingerprint = (
        b"0\x9a\xc9D\x83\xdc\x91'\x88\x91\x11\xa1d\x97\xfd"
        b"\xcb~7U\x14D@L"
...
async def test_tcp_connector_fingerprint_fail(aiohttp_server, aiohttp_client, ssl_ctx):
