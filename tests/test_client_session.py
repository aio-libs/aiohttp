...
async def test_session_default_version(event_loop: asyncio.AbstractEventLoop) -> None:
...
async def test_default_proxy(event_loop: asyncio.AbstractEventLoop) -> None:
