...
def test_using_gzip_if_header_present_and_file_available(loop: asyncio.AbstractEventLoop) -> None:
...
def test_gzip_if_header_not_present_and_file_available(loop: asyncio.AbstractEventLoop) -> None:
...
def test_gzip_if_header_not_present_and_file_not_available(loop: asyncio.AbstractEventLoop) -> None:
    request = make_mocked_request("GET", "http://python.org/logo.png", headers={})
...
def test_gzip_if_header_present_and_file_not_available(loop: asyncio.AbstractEventLoop) -> None:
    request = make_mocked_request(
